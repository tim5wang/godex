...
- [Memory Design Principles](../docs/memory-design-principles.md) - project - Memory 模块目标、边界、组成和约束。2026-08-24 更新：新增 status 归档状态、last_referenced_at 时效信号、里程碑一键归档、Web 三栏看板；此前 2026-08-10 新增 work_method/work_fact 类型、笔记↔记忆双向联动、TencentDB 参考
- [Notes ↔ Memory 双向联动实现 (2026-08-10)](notes_memory_linking_2026_08_10.md) - project - 借鉴 TencentDB-Agent-Memory 的分层设计，在笔记 app 和记忆系统之间建立双向打通：笔记打开时展示相关记忆，记忆注入时追加笔记引用，envelopeWithNoteContext 注入相关记忆摘要
