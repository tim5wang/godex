...
export function serializeLayoutSnapshot(state: LayoutState): LayoutSnapshot {
  const { toggle: _t, setWidth: _sw, setGridPreset: _sgp, movePanelToGrid: _mp, swapPanelInGrid: _sp, swapGridSlots: _sgs, setGridRatio: _sgr, setMobileActiveTab: _sm, openTaskCenterDrawer: _o, closeTaskCenterDrawer: _c, reset: _r, ...snapshot } = state;
  void _t; void _sw; void _sgp; void _mp; void _sp; void _sgs; void _sgr; void _sm; void _o; void _c; void _r;
  return snapshot;
}
