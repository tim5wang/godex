...
- [Memory Design Principles](../docs/memory-design-principles.md) - project - Memory 模块目标、边界、组成和约束。2026-08-10 更新：新增 work_method/work_fact 类型、笔记↔记忆双向联动、TencentDB 参考
