...
func storedValues(file ConfigFile) map[string]any {
	values := map[string]any{
		...
		"agent.decision.enabled":                                 file.Agent.Decision.Enabled,
		"agent.decision.provider":                                strings.TrimSpace(file.Agent.Decision.Provider),
		"agent.decision.timeout_ms":                              file.Agent.Decision.TimeoutMS,
		"agent.decision.max_tokens":                              file.Agent.Decision.MaxTokens,
		...
		"control.center_token":                                   file.Control.CenterToken,
		"control.node_proxy_token":                               file.Control.NodeProxyToken,
		"control.credential":                                     "",
		...
		"control.sandbox_exec_on":                                file.Control.SandboxExecOn,
		...
		"tools.execution.relay_center":                           file.Tools.Execution.RelayCenter,
		"tools.execution.relay_node":                             file.Tools.Execution.RelayNode,
		"tools.execution.relay_token":                            "",
...
func effectiveValues(cfg *Config) map[string]any {
	...
	values := map[string]any{
		...
		"agent.decision.enabled":                                 cfg.Decision.Enabled,
		"agent.decision.provider":                                strings.TrimSpace(cfg.Decision.Provider),
		"agent.decision.timeout_ms":                              cfg.Decision.TimeoutMS,
		"agent.decision.max_tokens":                              cfg.Decision.MaxTokens,
		...
		"control.center_token":                                   cfg.Control.CenterToken,
		"control.node_proxy_token":                               cfg.Control.NodeProxyToken,
		...
		"control.sandbox_exec_on":                                cfg.Control.SandboxExecOn,
		...
		"tools.execution.relay_center":                           cfg.Tools.Execution.RelayCenter,
		"tools.execution.relay_node":                             cfg.Tools.Execution.RelayNode,
		"tools.execution.relay_token":                            cfg.Tools.Execution.RelayToken,
